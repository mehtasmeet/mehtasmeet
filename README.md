<h1 align="left"> Hey there, I'm Smeet 👋 </h1>
   ...
   <svg width="495" height="195" viewBox="0 0 495 195" fill="none" xmlns="http://www.w3.org/2000/svg">
	<style>
		...
		@keyframes rankAnimation {
			...
			to {
				stroke-dashoffset: 127.71487142093295;
			}
		}
	...
	<g data-testid="card-title" transform="translate(25, 35)">
		<g transform="translate(0, 0)">
			<text x="0" y="0" class="header" data-testid="header">Smeet Mehta's GitHub Stats</text>
		</g>
	</g>
		...
		<svg x="0" y="0">
			<g transform="translate(0, 0)">
				<g class="stagger" style="animation-delay: 450ms" transform="translate(25, 0)">
					...
					<text class="stat" x="190" y="12.5" data-testid="stars">12</text>
				</g>
			</g>
			<g transform="translate(0, 25)">
				<g class="stagger" style="animation-delay: 600ms" transform="translate(25, 0)">
					...
					<text class="stat" x="190" y="12.5" data-testid="commits">54</text>
				</g>
			</g>
